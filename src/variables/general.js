...
const widgetStories = [
  ...
  },
  {
    ...
    body: (
      <p>
        JIIT Sec-62, B.Tech in Computer Science Enginerring
      </p>
    ),
    footerTitle: "2015 - 2019"
  },
  {
    // Second story
    inverted: true,
  ...
  }/* ,
  {
    ...
    body: (
      <div>
        ...
        <p>
          Whatt wasn’t any Kanyes Set on his goals Kanye
        </p>
      </div>
    ),
    footer: (
